...
## Run in cloudshell
```cmd
gcloud alpha services api-keys create --display-name="PavillionGame" 
KEY_NAME=$(gcloud alpha services api-keys list --format="value(name)" --filter "displayName=PavillionGame")
